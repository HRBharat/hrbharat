  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      <header className="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center">
        <h1 className="text-2xl font-black text-teal-700 tracking-tight">HRBharat</h1>
        <div className="space-x-4">
          <Link href="/login" className="text-sm font-semibold text-slate-600 hover:text-slate-900">Sign In</Link>
          <Link href="/signup" className="bg-teal-700 text-white text-sm font-medium px-4 py-2 rounded-xl hover:bg-teal-800 transition-all">Create Account</Link>
        </div>
      </header>
